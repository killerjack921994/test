  ...
  def create
    ...
    respond_to do |format|
      if @manufacturer.save
        format.html { redirect_to new_manufacturer_path, notice: 'Manufacturer was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @manufacturer.update(manufacturer_params)
        format.html { redirect_to edit_manufacturer_path, notice: 'Manufacturer was successfully updated.' }
